# คู่มือ Mission Control Game

คู่มือฉบับใหม่แยกตามบทบาท เพื่อไม่ให้ข้อมูลสำหรับผู้ดำเนินเกมกลายเป็นคำใบ้แก่ผู้เล่น
...
> คู่มือ Facilitator มีข้อมูลลับและแนวทางให้คะแนน ไม่ควรส่งให้ผู้เล่นก่อนจบกิจกรรม
